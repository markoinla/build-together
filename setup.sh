...
echo "  2. In a separate terminal, run './mcp/run_mcp.sh' to start the MCP server"
echo "  3. Access the application at http://127.0.0.1:5001"
echo ""
echo "For MCP integration with Windsurf:"
echo "  1. Configure Windsurf to use the MCP server at: $(pwd)/mcp/run_mcp.sh"
echo ""
echo "Enjoy using Build Together!"
